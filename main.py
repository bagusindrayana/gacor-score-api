...
def search_google(search_query):
    ...
    for result in results:
        title = base64.b64encode(bytes(result.find_element(By.TAG_NAME, "h3").text, 'utf-8'))
        link = base64.b64encode(bytes(result.find_element(By.TAG_NAME, "a").get_attribute("href"), 'utf-8'))
...
for prov in provinsiLinks:
    ...
    with open("./result-scan/"+prov+".json", "w") as f:
